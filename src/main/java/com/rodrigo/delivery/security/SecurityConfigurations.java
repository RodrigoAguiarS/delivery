...
public class SecurityConfigurations {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors() // Adicione esta linha para habilitar o CORS
                ...
                .antMatchers(HttpMethod.POST, "/login-alterar").permitAll()
                .antMatchers(HttpMethod.POST, "/login-alterar/**").permitAll()
                .antMatchers(HttpMethod.GET, "/login-alterar/**").permitAll()
                .antMatchers(HttpMethod.POST, "/api/auth/criar").permitAll()
                .antMatchers(HttpMethod.GET, "/api/actuator/**").authenticated()
                .antMatchers(HttpMethod.GET, "/api/auth/isAdmin").authenticated()
